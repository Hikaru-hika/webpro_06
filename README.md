...
## このプログラムについて
このプログラムは，Nodeとhtmlを使用したWebアプリケーションで，主な機能として，じゃんけんやおみくじ，運転免許学科試験のような小さなゲームやクイズ機能を提供するものである．app5.jsに各機能のURLへの振り分けと処理の内容が書かれており，ユーザーはURLにアクセスするだけでこれらの機能を利用できるようになっている．
...
1. ターミナルでcdコマンドを使用し，webpro_06まで移動
1. 誰が変更したか明らかにするため，以下のコマンドを実行し，ユーザ名とメールアドレスを登録(ユーザ名とメールアドレスは，自身のを書く)
